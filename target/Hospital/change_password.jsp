...
<div class="container p-4">
	...
	<div class="card paint-card">
		...
		<div class="card-body">
			<form action="../patientUpdateProfile" method="post" accept-charset="UTF-8">
				<!-- Form thông tin -->
				<div class="mb-3">
				...
				<div class="mb-3">
					...
					<input type="password" name="password" class="form-control" readonly required value="${userObj.password}">
				</div>
				<div class="mb-3">
				...
				<div class="mb-3">
					...
					<select name="gender" class="form-control" required>
						<option value="Nam" ${userObj.gender == 'Nam' ? 'selected' : ''}>Nam</option>
						<option value="Nữ" ${userObj.gender == 'Nữ' ? 'selected' : ''}>Nữ</option>
					</select>
				</div>
